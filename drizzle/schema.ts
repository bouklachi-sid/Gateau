...
export const contentPosts = mysqlTable(
  "content_posts",
  {
    ...
    visualComplianceStatus: mysqlEnum("visualComplianceStatus", ["pending_review", "approved", "rejected"]).default("pending_review").notNull(),
    visualComplianceNote: text("visualComplianceNote"),
    visualPhoneNumber: varchar("visualPhoneNumber", { length: 40 }),
    visualOrderCallout: varchar("visualOrderCallout", { length: 80 }),
    visualSceneDirection: varchar("visualSceneDirection", { length: 700 }),
    visualMediaAssetId: int("visualMediaAssetId"),
    visualRetouched: int("visualRetouched").default(0).notNull(),
    visualDecor: varchar("visualDecor", { length: 160 }),
    visualLighting: varchar("visualLighting", { length: 160 }),
    visualAngle: varchar("visualAngle", { length: 160 }),
    visualProps: varchar("visualProps", { length: 160 }),
    visualMood: varchar("visualMood", { length: 160 }),
    cakePreserved: int("cakePreserved").default(0).notNull(),
    professionalStagingApproved: int("professionalStagingApproved").default(0).notNull(),
    phoneNumberInImage: int("phoneNumberInImage").default(0).notNull(),
    visualVerifiedAt: timestamp("visualVerifiedAt"),
...
export const mediaAssets = mysqlTable(
  "media_assets",
  {
    ...
    retouchStatus: mysqlEnum("retouchStatus", ["original", "retouched"]).default("original").notNull(),
    retouchedAt: timestamp("retouchedAt"),
